package com.arathin.springmysql.myservices;

import com.arathin.springmysql.model.Tutorial;
import com.arathin.springmysql.repository.TutorialRepository;
...
public class TutorialServices {
    ...
    public Optional<Tutorial> getTutorialById(Long id) {
        return  tutorialRepository.findById(Math.toIntExact(id));
    }
